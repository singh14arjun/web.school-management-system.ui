    ...
    return (
        ...
        <div className="flex flex-col gap-10 animate-fade-in">
            <section className='p-4 flex justify-between gap-10'>
                <div className="flex items-center gap-4 animate-slide-up delay-1">
                    <Avatar
            ...
            <section className="grid grid-cols-3 gap-10">
                ...
                <div className="bg-white rounded-2xl shadow-sm p-6 flex flex-col gap-4 animate-slide-up delay-1">
                ...
                <div className="bg-white rounded-2xl shadow-sm p-6 flex flex-col gap-4 animate-slide-up delay-2">
                ...
                <div className="bg-white rounded-2xl shadow-sm p-6 flex flex-col gap-4 animate-slide-up delay-3">
                    ...
                    <h2 className="text-3xl font-bold text-gray-800">
                        {school?.totalFacilities ? Math.round(((school?.totalFacilities - 10) / school?.totalFacilities) * 100) : `N/A`}
                    </h2>
                    ...
                    <div className="w-full h-2 bg-gray-200 rounded-full">
                        <div
                            ...
                            style={{
                                width: `${((school?.totalFacilities - 10) / school?.totalFacilities) * 100}%`
                            }}
                        />
                    </div>
            ...
            <section className='flex gap-10 mt-10'>
                <div className='w-2/3 flex flex-col gap-5 animate-slide-up delay-3'>
                    <div className='flex flex-col gap-5 animate-slide-up delay-3'>
                    ...
                    <div>
                        ...
                        <div className='grid grid-cols-4 gap-4 bg-white rounded-2xl shadow-sm p-6 flex-col gap-4 animate-slide-up delay-4'>
                            ...
                            <div className='flex flex-col gap-1 bg-blue-100 p-2 rounded-lg'>
                                ...
                                <p className='text-sm text-gray-500 font-medium'>Ratio</p>
                            </div>
                            <div className='flex flex-col gap-1 bg-blue-100 p-2 rounded-lg'>
                                <p className='text-2xl text-blue-500 font-bold'>{school?.totalFacilities || `N/A`}</p>
                    ...
                    <div className='flex flex-col gap-5'>
                        ...
                        <div className="grid grid-cols-2 gap-3 animate-slide-up delay-6">
                ...
                <div className="flex flex-col gap-4 w-1/3 bg-white rounded-2xl shadow-sm p-6 h-fit items-center animate-slide-up delay-4">
