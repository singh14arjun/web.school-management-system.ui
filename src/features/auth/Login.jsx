...
const SchoolIllustration = () => (
  ...
  >
    ...
    <path
      d="M60 300c20-40 10-80 40-100s50 10 40 50-30 60-50 70-40 20-30-20z"
      fill="#c8e6c9"
      opacity="0.6"
    />
    <path
      d="M420 250c-15-35 5-70 30-85s40 15 30 50-25 55-40 60-30 10-20-25z"
      fill="#c8e6c9"
      opacity="0.5"
    />
    ...
    <rect
      ...
      strokeWidth="1.5"
    />
    <text x="335" y="88" fontSize="14" fill="#FF8F00">
      &#9733;&#9733;&#9733;&#9733;&#9733;
    </text>
    <rect x="335" y="96" width="80" height="6" rx="3" fill="#1565C0" />
    <polygon
      points="370,115 375,120 365,120"
      fill="white"
      stroke="#E0E0E0"
      strokeWidth="1"
    />
    ...
    <path
      d="M360 308c0 0-10 5-15 30s-5 30 5 30h50c10 0 5-20 0-30s-15-30-15-30"
      fill="#1565C0"
    />
...
const Login = () => {
  ...
  const { request: login, loading, error } = useApi(loginUser);
                ...
                <Form className="space-y-4 animate-fade-in">
                  ...
                  <div className="flex items-center justify-between text-sm">
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        type="checkbox"
                        className="w-4 h-4 rounded border-slate-300 text-blue-600 focus:ring-blue-200 accent-blue-600"
                      />
